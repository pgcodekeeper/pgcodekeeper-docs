...
- |switch| - поменять местами вид слева и вид справа.
...
Данная панель показывает зависимости, в которых участвует текущий объект, выбранный в панели различий активного редактора проекта.
...
В pgCodeKeeper есть возможность отобразить зависимости объекта в виде нисходящего или восходящего дерева. Для этого в таблице различий выделите нужный объект и в контекстном меню выберите **Build a dependency graph / Построить граф зависимостей**

.. image:: ../images/diff_table_viewer_menu.png
    :scale: 50%

После чего откроется диологовое окно с настройками на основе которых будет строится дерево

.. image:: ../images/build_graph_dialog.png
    :scale: 50%

**Schema source: / Источник схемы:** - источник данные проекта(**Project /Проект**) или удаленного сервера(**Remote / БД**).

**Show: / Показать:** - зависимые объекты(**Calls / Вызовы**) или объекты от которых зависит(**Dependencies / Зависимости**) объект.

**Graph search depth / Глубина поиска** - глубина поиска зависимостей по графу, по умолчанию 10.

**Object Type / Тип объекта** - типы объектов которые будут отображаться, по умолчанию отображаются все типы.

...
Количество строк, получаемых в результатах запроса не ограниченно. 

.. attention:: Если результат запроса слишком большой(100к и более строк), то графический интерфейс подвисает.

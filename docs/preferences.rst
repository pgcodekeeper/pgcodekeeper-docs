...
- **Migrate data when re-creationg tables / Мигрировать данные при пересоздании таблиц** - опция, позволяющая пересоздавать таблицы с сохранением данных в ней. Перенос данных осуществляется для таблиц с IDENTITY SEQUENCE колонками.

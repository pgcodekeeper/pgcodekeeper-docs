...
- **Simplified reading of NOT NULL constraints via JDBC (only for PostgreSQL 18+) / Упрощенное чтение ограничений NOT NULL через JDBC (только для PostgreSQL 18+)**
...
- **Use parallel database loading / Использовать параллельную загрузку БД**

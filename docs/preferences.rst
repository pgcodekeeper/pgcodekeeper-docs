...
На странице настроек **pgCodeKeeper -> DB Store / Хранилище БД -> Connection type / Тип соединения** находится список записей в котором можно задать кастомную подсветку для разных типов соединений. Функционал и внешний вид аналогичен с страницей **DB Store / Хранилище ДБ**. Ниже вы можите увидеть диологовое окно с параметрами типов соединения.

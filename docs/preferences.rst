...
- **Print comments at the end of the script / Печатать комментарии в конце скрипта** - переносит добавление всех коментариев в конец скрипта миграции.

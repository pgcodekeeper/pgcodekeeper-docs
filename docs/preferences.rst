...
**Принцип работы** название подключения будет выделенно выбранным цветом подсветки. Для хранилища БД это наглядно продемонстрированно на скриншоте выше :ref:`dbStore`, а ниже для панели инструметов и SQL редактора.

...
latex_documents = [
  ('index', 'pgCodeKeeper.tex', 'Руководство по установке и эксплуатации',
   'pgCodeKeeper', 'manual'),
]
...
man_pages = [
    ('index', 'pgCodeKeeper', 'pgCodeKeeper Documentation',
     ['pgCodeKeeper'], 1)
]
...
texinfo_documents = [
  ('index', 'pgCodeKeeper', 'pgCodeKeeper Documentation',
   'pgCodeKeeper', 'pgCodeKeeper', 'One line description of project.',
   'Miscellaneous'),
]

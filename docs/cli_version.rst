...
Список правил для проверки хранится в файле **rules.properties**.

Стилистические правила. Могут принимать значение true - включить проверку или false - выключить проверку (дефолтное значение).

- **check_indents** - проверка отступов. (в разработке)
...
./pgcodekeeper-cli.sh --mode VERIFY --verify-rule-set /home/user/rules.properties --verify-source /home/user/functions
